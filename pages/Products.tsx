      ...
      <section className="container mx-auto px-6 mb-24">
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, idx) => (
            <StaggerItem key={idx}>
                <HoverCard className="glass-card rounded-2xl overflow-hidden group flex flex-col h-full hover:border-brand-accent/30">
                  {/* Image Header */}
                  <div className="h-48 overflow-hidden relative bg-brand-darker border-b border-white/5">
                     <motion.img 
                        ...
                        src={product.image} 
                        alt={product.name} 
                        className="w-full h-full object-cover opacity-80 mix-blend-luminosity group-hover:opacity-100 group-hover:mix-blend-normal" 
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto">
                        ...
                        <Link to="/portfolio" className="block">
                            <motion.div
                                className="w-full py-3 border border-white/10 bg-white/5 text-white font-bold rounded-lg hover:bg-brand-accent hover:text-brand-darker hover:border-brand-accent text-sm flex items-center justify-center gap-2 group-hover:shadow-[0_0_15px_rgba(196,242,46,0.15)] transition-colors"
                            >
        ...
        <Reveal>
            <div className="glass-panel p-10 md:p-16 rounded-3xl border border-white/10 relative overflow-hidden text-center">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    ...
                    <Link to="/contact">
                        <MagneticButton className="inline-flex px-10 py-4 bg-brand-accent text-brand-darker font-bold rounded-full shadow-[0_0_20px_rgba(196,242,46,0.3)] hover:bg-white hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] transition-all items-center gap-2">
